...
chunk.ratios.m <- read.csv(file="Results_Nov-2016/MetaData_AllGreek_35Tokens.csv", stringsAsFactors = FALSE, header = TRUE)
dim(chunk.ratios.m)
chunk.ratios.m[,2]
View(chunk.ratios.m)
...
for (i in 1:100) {
  ...
  testing.index.v <- sample (seq (1, nrow(smaller.df)), 1641, prob = chunk.ratios.m[, 2])
...
save(svm.error.matrix.l, file="Results_NOv-2016/svmErrorMatrix_35tokens_Dec-4-2016.R")
save(svm.results.l, file="Results_Nov-2016/svmResults_35tokens_Dec-4-2016.R")
write.csv(a, file = "Results_Nov-2016/svmError_Spreadsheet_35tokens_Dec-4-2016.csv")
...
save(svm.error.matrix.l, file="Results_NOv-2016/svmErrorMatrix_35tokens_Dec-4-2016.R")
save(svm.results.l, file="Results_Nov-2016/svmResults_35tokens_Dec-4-2016.R")
write.csv(b, file = "Results_Nov-2016/svmError_Spreadsheet_35tokens_Dec-4-2016.csv")
