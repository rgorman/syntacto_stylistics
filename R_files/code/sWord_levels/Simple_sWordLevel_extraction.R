...
for (i in 1: length(files.v)) {
  ...
  geodesics <- getNodeSet(doc.object, "//word/*")
...
# remove large files no longer needed (if processing large file)
rm(chunks.l, doc.object, freq.table, freq.table.l, freqs.l, geodesic.content, geodesic.table, geodesics, word.nodes)
